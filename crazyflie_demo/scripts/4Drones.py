...
if __name__ == '__main__':
	...
	cf1 = crazyflie.Crazyflie("crazyflie3", "crazyflie7")

	cf1.setParam("commander/enHighLevel", 1)

	cf2 = crazyflie.Crazyflie("crazyflie7", "crazyflie7")

	cf2.setParam("commander/enHighLevel", 1)

	cf3 = crazyflie.Crazyflie("crazyflie6", "crazyflie6")

	cf3.setParam("commander/enHighLevel", 1)
	
	cf4 = crazyflie.Crazyflie("crazyflie2", "crazyflie2")
	...
	try:
		...
		cf3.takeoff(targetHeight = 0.5, duration = 2.0)
		cf4.takeoff(targetHeight = 0.5, duration = 2.0)
		time.sleep(5.0)
		...
		cf4.goTo(goal = [-0.5, 0.0, 0.5], yaw=0.2, duration = 2.0, relative = False)
		time.sleep(3.0)

		cf2.goTo(goal = [0.5, 0.0, 0.5], yaw=0.2, duration = 2.0, relative = False)
		cf3.goTo(goal = [0.0, 0.5, 0.5], yaw=0.2, duration = 2.0, relative = False)
		cf4.goTo(goal = [0.0, -0.5, 0.5], yaw=0.2, duration = 2.0, relative = False)
		cf1.goTo(goal = [-0.5, 0.0, 0.5], yaw=0.2, duration = 2.0, relative = False)
		time.sleep(3.0)
